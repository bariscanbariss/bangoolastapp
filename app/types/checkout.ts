...
export const CHECKOUT_STEPS: {
  ...
  { id: 'address', title: 'address-step', icon: 'environment' },
  { id: 'delivery', title: 'delivery-step', icon: 'inbox' },
  { id: 'payment', title: 'payment-step', icon: 'wallet' },
  { id: 'review', title: 'review-step', icon: 'profile' },
];
...
export const addressSchema = z.object({
  ...
  country_code: z.string().min(1, 'country-code-is-required').default('tr'),
